...
import  {  DashboardService,PagerService, PaymentService, RoleService} from '../_service';
...
@NgModule({
  ...
  entryComponents : [TopupComponent
   
  ],
  providers: [DashboardService ,PagerService,RoleService,PaymentService]
})
