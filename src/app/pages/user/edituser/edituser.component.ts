...
export class EdituserComponent implements OnInit {
  ...
  createForm() {
       this.EditAdminForm = this.fb.group({
        ...
        gender: new FormControl(this.editdata ? this.editdata['gender'] : ''),
        ...
        dob: new FormControl(this.editdata ['dob']!= null ? moment(this.editdata['dob']).format('YYYY-MM-DD') : ''),
        // dob: new FormControl(this.editdata != null ? this.editdata['dob'].slice(0, 10) : ''),
