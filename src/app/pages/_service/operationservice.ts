...
export class OperationService {
  ...
  async ottrenewal(params) {
    return await this.http.post("/operation/ottrenewal", params).toPromise();
  }
  async recheckOttStatus(params){
    return await this.http.post("/operation/recheckOttStatus", params).toPromise();
  }
}